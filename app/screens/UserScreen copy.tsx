...
const UserScreen: React.FC = () => {
    ...
    return (
        <View style={styles.container}>
            <Text style={[styles.userText,{fontWeight:"bold"}]}>Welcome {username}</Text>
            <Text style={{fontSize:15}}>This is your booked flight</Text>
            <ScrollView style={{ flex: 1 }}>
                {flightData && flightData.length > 0 ? (
                    ...
                    <Text>No booked flights available.</Text> // Display message when no flights
                )}
            </ScrollView>
        </View>
    );
